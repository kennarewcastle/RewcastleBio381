# Basic code for batch processing files -- BREAKING the program
# 28 March 2018
# KER

#########################################################################################################
# FUNCTION: FileBuilderBreak
# create a set of random files for regression -- Breaking program by altering NAs and minimum rows
...
# Global variables
fileFolder<-"RandomFilesBreak/"
nFiles<-100
fileOut<-"StatsSummaryBreak.csv"

# Create 100 random datasets
FileBuilderBreak(fileN=nFiles)
